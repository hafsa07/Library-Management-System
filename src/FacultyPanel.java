...
public class FacultyPanel {
    ...
    private static void createSlidingPanel() {
        ...
        // adding components
        Runner.facultyPanel.add(sliding_panel);
        Runner.facultyPanel.add(sliding_button);
    }
    ...
    private static void createSearchPanel() {
        ...
        // adding components
        Runner.facultyPanel.add(search_panel);
    }
    ...
    private static void createHistoryPanel() {
        ...
        // adding components
        Runner.facultyPanel.add(history_panel);
    }
    ...
    private static void createReturnPanel() {
        ...
        // adding components
        Runner.facultyPanel.add(return_panel);
    }
    ...
    public static void createProfilePanel() {
        ...
        profileTable.setValueAt("DEPARTMENT",1,0);
        ...
        // adding component
        Runner.facultyPanel.add(profile_panel);
    }
    ...
    public static void createFrame() {
        ...
        createSlidingPanel();
        createHistoryPanel();
        Runner.frame.add(Runner.facultyPanel);
    ...
    private static void actionsClicked() {
        ...
        profile_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                profileTable.setValueAt(Runner.faculty.getName(), 0, 1);
                profileTable.setValueAt(Runner.faculty.getDepartment(), 1, 1);
                profileTable.setValueAt(Runner.faculty.getContact(), 2, 1);
                profileTable.setValueAt(Runner.faculty.getNoOfIssuedBooks(), 3, 1);
                profileTable.setValueAt(Runner.faculty.getFine(), 4, 1);
        ...
        return_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < Runner.faculty.getIssuedBooks().size(); i++) {
                    if (Runner.faculty.getIssuedBooks().get(i) != null) {
                        model.add(i, Runner.faculty.getIssuedBooks().get(i).getName());
                    }
                }
        ...
        history_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                historyarea.append(filingText.getText(Runner.faculty.username));
        ...
        logout_button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Runner.facultyPanel.setVisible(false);
                ...
                for (int i = 0; i < books.size(); i++) {
                    if (bookTextField.getText().equals(books.get(i).getName())) {
                        ...
                        for (int j = 0; j < faculties.size(); j++) {
                            if (Runner.faculty.getUsername().equals(faculties.get(j).getUsername())) {
                                faculties.add(j, Runner.faculty);
                                break;
                            }
                        }

                        filingFaculty.writeAll(faculties);
                        library.writeAll(books);

                        // Adding History ==============================================================================
                        filingText.addText(Runner.faculty.getUsername()+"[Faculty] issued : "+book.getName()+" , "+book.getAuthorName()+" , "+book.getEdition(),"AdminHistory");
                        filingText.addText("Issued : "+book.getName()+" , "+book.getAuthorName()+" , "+book.getEdition(),Runner.faculty.username);
                        // =============================================================================================
        ...
        returnBook_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selected != null) {
                    ...
                    // Removing book from faculty
                    for (int i = 0; i < Runner.faculty.getIssuedBooks().size(); i++) {
                        if (Runner.faculty.getIssuedBooks().get(i).getName().equals(selected)) {
                            Book book = Runner.faculty.getIssuedBooks().get(i);
                            Runner.faculty.removeBook(book);
                            books.add(book);
                            filingFaculty.update(Runner.faculty);
                            filingLibrary.writeAll(books);

                            // Adding History ==============================================================================
                            filingText.addText(Runner.faculty.getUsername()+"[Faculty] returned : "+book.getName()+" , "+book.getAuthorName()+" , "+book.getEdition(),"AdminHistory");
                            filingText.addText("Returned : "+book.getName()+" , "+book.getAuthorName()+" , "+book.getEdition(),Runner.faculty.username);
                            // =============================================================================================
